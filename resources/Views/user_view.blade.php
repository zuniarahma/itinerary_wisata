                        ...
                        <div class="box">
                            <div class="box-body">
                                <table border="1">
                                    ...
                                    <a href="{{url('/insertuser')}}" class="btn btn-success" role="button">insert</a>
                                    <p>
                                    <tr>
                                        <td>ID User</td>
                                        <td>ID Role</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $users->alamat }}</td>
                                        <td><a href='edituser/{{ $users->id_user }}' class="btn btn-info" role="button">Edit</a></td>
                                        <td><a href='deleteuser/{{ $users->id_user }}' class="btn btn-danger" role="button">Delete</a></td>
                                    </tr>
                                    @endforeach
                                </table>
                            </div>
