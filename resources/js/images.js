    ...
    $.ajax("api/joinwisata")
        .done(function (data) {
            ...
            $.each(data, function (key, value) {
                ...
                selector.append("<div class='col-xs-6 col-sm-6 col-md-6 col-lg-6'>" + "<img src='http://localhost/TA/itinerary/public/data_file/" + value.file +"' /><a href='http://localhost/TA/itinerary/public/detail_wisata/" + value.id_wisata +"' >"+ value.nama_wisata + "</a></div>");
