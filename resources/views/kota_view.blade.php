                        ...
                        <div class="box">
                            <div class="box-body">
                                <table border="1">
                                    ...
                                    <a href="{{url('/insertkota')}}" class="btn btn-success" role="button">insert</a>
                                    <p>
                                    <tr>
                                        <td>ID Kota</td>
                                        <td>Nama Kota</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href='editkota/{{ $kotas->id_kota }}' class="btn btn-info" role="button">Edit</a></td>
                                        <td><a href='deletekota/{{ $kotas->id_kota }}' class="btn btn-danger" role="button">Delete</a></td>
                                    </tr>
                                    @endforeach
                                </table>
                            </div>
