...
<head>
    ...
    <title>Jenis Wisata Management</title>
    ...
    <link rel="stylesheet"
        href="{{asset('bower_components/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')}}">
                        ...
                        <div class="box">
                            <div class="box-body">
                                <table border="1">
                                    ...
                                    <a href="{{url('/insertjenis')}}" class="btn btn-success" role="button">insert</a>
                                    <p>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href='editjenis/{{ $jenis_wisatas->id_jenis_wisata }}' class="btn btn-info" role="button">Edit</a></td>
                                        <td><a href='deletejenis/{{ $jenis_wisatas->id_jenis_wisata }}' class="btn btn-danger" role="button">Delete</a></td>
                                    </tr>
                                    @endforeach
                                </table>
                            </div>
