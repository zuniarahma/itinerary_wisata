...
function getDurations(callback) {
    ...
    service.getDistanceMatrix({
        ...
        var nodeDistanceData; //dapet dari distance data
        for (originNodeIndex in distanceData.rows) {
            ...
            console.log("nodeDistanceData: ", nodeDistanceData);
            // console.log("originNodeIndex: ", originNodeIndex);
            console.log("distanceData: ", distanceData);
            // console.log("distanceData.rows: ", distanceData.rows);
